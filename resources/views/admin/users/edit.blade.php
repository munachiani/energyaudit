                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-12">
                                <form action={{url('Users/ChangeAvatar')}} method="post" enctype="multipart/form-data"
                                      id="pixform">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6 form-group">
                                            <label for="file">Upload Image: (200 by 200, max. file size: 100KB, must be
                                                .jpg, .jpeg or .png)</label>

                                            <div id="msg" class="alert alert-danger hidden">Picture size is greater than
                                                100kb. Please select another picture
                                            </div>
                                            <input type="file" name="ImageInfo" class="form-control" required/>
                                        </div>
                                        @if ($errors->has('ImageInfo')) <span class="help-block"
                                                                              style="color:red">{{ $errors->first('ImageInfo') }}</span> @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6 form-group">
                                            <input type="submit" onclick="$('#logloader').css('display','')"
                                                   value="Change Avatar"
                                                   class="submit btn btn-raised ink-reaction btn-default" id="upload"/>
                                            <img id="logloader" style="display: none;"
                                                 src="{{url('userimages/loader.gif')}}" alt="Loading..."/>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-7">
                                    ...
                                    <div class="form-group col-md-12 required">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control text-box single-line" data-val="true"
                                                   ...
                                                   data-val-required="The Last Name field is required." id="LastName"
                                                   name="LastName" required="required" type="text"
                                                   value="{{$user->LastName}}"/>
                                            @if ($errors->has('LastName')) <span
                                                    class="field-validation-valid text-danger" style="color:red"
                                                    data-valmsg-for="LastName"
                                                    data-valmsg-replace="true">{{ $errors->first('LastName') }}</span> @endif
                                    ...
                                    <div class="form-group col-md-12 required">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control text-box single-line" data-val="true"
                                                   ...
                                                   data-val-regex-pattern="^[a-zA-Z]+$"
                                                   data-val-required="The First Name field is required." id="FirstName"
                                                   name="FirstName" required="required" type="text"
                                                   value="{{$user->FirstName}}"/>
                                            @if ($errors->has('FirstName'))  <span
                                                    class="field-validation-valid text-danger"
                                                    data-valmsg-for="FirstName"
                                                    data-valmsg-replace="true">{{ $errors->first('FirstName') }}</span>@endif
                                    ...
                                    <div class="form-group col-md-12 required">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control text-box single-line" data-val="true"
                                                   ...
                                                   name="MiddleName" required="required" type="text"
                                                   value="{{$user->MiddleName}}"/>
                                            @if ($errors->has('MiddleName')) <span
                                                    class="field-validation-valid text-danger"
                                                    data-valmsg-for="MiddleName"
                                                    data-valmsg-replace="true">{{ $errors->first('MiddleName') }}</span> @endif
                                    ...
                                    <div class="form-group col-md-12 required">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control text-box single-line" id="Email" name="Email"
                                                   readonly="" required="required" type="email"
                                                   value="{{$user->Email}}"/>

                                            @if ($errors->has('Email')) <span class="field-validation-valid text-danger"
                                                                              data-valmsg-for="Email"
                                                                              data-valmsg-replace="true">{{ $errors->first('Email') }}</span>@endif
                                ...
                                <textarea class="form-control" cols="20" id="Address" name="Address" rows="2">{{$user->Address}}
                                            ...
                                            @if ($errors->has('Address')) <span
                                                    class="field-validation-valid text-danger" data-valmsg-for="Address"
                                                    data-valmsg-replace="true">{{ $errors->first('Address') }}</span>@endif
                                    ...
                                    <div class="form-group col-md-12 required">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control text-box single-line" data-val="true"
                                                   ...
                                                   data-val-regex-pattern="^\s*\+?\s*([0-9][\s-]*){2,}$"
                                                   data-val-required="The Phone Number field is required."
                                                   id="PhoneNumber" name="PhoneNumber" required="required" type="text"
                                                   value="{{$user->PhoneNumber}}"/>
                                            @if ($errors->has('PhoneNumber'))  <span
                                                    class="field-validation-valid text-danger"
                                                    data-valmsg-for="PhoneNumber"
                                                    data-valmsg-replace="true">{{ $errors->first('PhoneNumber') }}</span> @endif
                                    ...
                                    <div class="form-group col-md-12 required">
                                        ...
                                        ?>
                                        <div class="col-md-10">
                                            <input class="form-control text-box single-line" id="UserRoles"
                                                   name="UserRoles" readonly="" required="required" type="text"
                                                   value="{{$userRoles}}"/>
                                            <span class="field-validation-valid text-danger" data-valmsg-for="UserRoles"
                                    ...
                                    @if(($user->latestRole()->role->id) == 6)
                                        <div class="form-group col-md-12">
                                            <div class="col-md-offset-2 col-md-10">
                                                <a class="btn btn-raised btn-sm ink-reaction btn-default"
                                                   href="{{url('Users/ManageRole/'.$user->id)}}">Manage User Roles</a>
                                            </div>
                                        </div>
                                    @endif
                                    <div class="form-group col-md-12 required">
                                        ...
                                        <div class="col-md-10 required">
                                            <input class="form-control text-box single-line" id="UserRoles"
                                                   name="Gender" readonly="" required="required" type="text"
                                                   value="{{$user->Gender}}"/>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="col-md-offset-2 col-md-10">
                                            <input type="submit" value="Save"
                                                   class="btn btn-raised btn-sm ink-reaction btn-default"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if($userRoleIDs == \App\Role::$FIELD_AGENT || $userRoleIDs ==\App\Role::$REGIONAL_ADMIN || $userRoleIDs == \App\Role::$REGIONAL_SUPERVISOR)
                            <div class="col-md-offset-1 col-md-4">
                                <form action="/Users/AssignRegion" method="post"><input
                                    ...
                                    <div class="">
                                        <input id="Id" name="Id" type="hidden"
                                               value="8d1b5d88-aaa6-438a-b5d7-3112e2385bc1"/>
                                        <input data-val="true"
                                               data-val-regex="First Name should contain only alphabets."
                                               data-val-regex-pattern="^[a-zA-Z]+$"
                                               data-val-required="The First Name field is required." id="FirstName"
                                               name="FirstName" type="hidden" value="Yode"/>
                                        <input data-val="true"
                                               data-val-regex="Middle Name should contain only alphabets."
                                               data-val-regex-pattern="^[a-zA-Z]+$" id="MiddleName" name="MiddleName"
                                               type="hidden" value="Kay"/>
                                        <input data-val="true" data-val-regex="Last Name should contain only alphabets."
                                               data-val-regex-pattern="^[a-zA-Z]+$"
                                               data-val-required="The Last Name field is required." id="LastName"
                                               name="LastName" type="hidden" value="Kayode"/>
                                        <input data-val="true" data-val-regex="Enter a valid Email Address"
                                               ...
                                               type="hidden" value="korttech@gmail.com"/>
                                                    ...
                                                    <table class="table table-striped" width="50">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <input type="checkbox" class="box checkbox hidden"
                                                                       name="todelete" value="516"/>
                                                            </td>
                                                            <td>
                                                                Lagos
                                                            </td>
