                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <span class="alert alert-info" style="display: none;">Please note that the excel sheet to be uploaded should be in the same format as the approved template. <a href="{{url('userimages/MDAEnergyAuditSample.xlsx')}}" class="btn btn-danger">Click here</a> to download a template of the approved format</span>
                        </div>
                    </div>
                </div>
